...
/* harmony import */ var _modules_travel_cost_display__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/travel_cost_display */ "./src/modules/travel_cost_display.js");
...
if (document.querySelector('.travelCostContainer')) {
  new _modules_travel_cost_display__WEBPACK_IMPORTED_MODULE_1__["default"]();
}
...
class Messages {
  ...
  constructor(productId) {
    let timeout = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3500;
    this.timeOutCounter;
    this.messagebox;
...
/***/ "./src/modules/travel_cost_display.js":
/*!********************************************!*\
  !*** ./src/modules/travel_cost_display.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _messages__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./messages */ "./src/modules/messages.js");
...
class TravelCostLogic {
  ...
  constructor() {
    //error messages
    this.messages = new _messages__WEBPACK_IMPORTED_MODULE_1__["default"]("", 10000);
    //this.addressForm = document.querySelector('.travelcostaddressform')
    (axios__WEBPACK_IMPORTED_MODULE_0___default().defaults.headers.common["X-WP-Nonce"]) = gge_travel_stored_data.nonce;
  ...
  async processAddressViaGoogleMapsAPI() {
    ...
    //Send
    try {
      let response = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(gge_travel_stored_data.root_url + "/wp-json/gge_travel_cost/v1/process-travel-address-cost-route", formData);
...
//Required to export the class to the js index file
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TravelCostLogic);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunktravelcostfrontend"] = globalThis["webpackChunktravelcostfrontend"] || [];
